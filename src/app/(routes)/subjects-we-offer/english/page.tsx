...
import EnglishDetails from "@/components/MarketingAgency/PortfolioDetails/English";
import englishDetailsData from "@/constant/MarketingAgency/PortfolioDetails/english-details-data";
import EnglishCourse from "@/components/AiAgency/EnglishCourse";
import EnglishTutors from "@/components/AiAgency/EnglishTutor";
      ...
      <SmoothScroll>
        <main>
          <Breadcrumb
            ...
            pageName="ENGLISH "
          />
          <EnglishDetails data={englishDetailsData} />
