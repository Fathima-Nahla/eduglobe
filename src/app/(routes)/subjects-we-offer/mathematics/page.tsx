...
import MathematicsDetails from "@/components/MarketingAgency/PortfolioDetails/Mathematics";
import matehmaticsDetailsData from "@/constant/MarketingAgency/PortfolioDetails/matehmatics-details-data";
import MathCourse from "@/components/AiAgency/MathCourse";
import MathTutors from "@/components/AiAgency/MathTutor";
    ...
    <div className="body-wrapper body-inner-page">
      ...
      <SmoothScroll>
        <main>
          ...
          />
          <MathematicsDetails data={matehmaticsDetailsData} />
