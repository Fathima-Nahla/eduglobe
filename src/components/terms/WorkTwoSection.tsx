...
const tutors2 = [
  ...
  },
  {
    ...
    background: "/assets/images/science/img4.jpg",
    rating: 5.0,
    rate: 55,
    experience: "9yr",
    tags: ["Biology"],
  },
  {
    ...
    background: "/assets/images/science/img5.jpg",
    rating: 4.7,
    rate: 48,
    experience: "7yr",
  ...
  },
  {
    ...
    background: "/assets/images/science/img6.jpg",
    rating: 4.8,
    rate: 47,
    experience: "6yr",
    tags: ["Physics"],
  },
  {
    ...
    background: "/assets/images/science/img7.jpg",
    rating: 5.0,
    rate: 60,
    experience: "15yr",
    tags: ["Physics", "Chemistry"],
  },
  {
    ...
    background: "/assets/images/science/img8.jpg",
    rating: 4.9,
    rate: 52,
    experience: "11yr",
  ...
  },
  {
    ...
    background: "/assets/images/science/img9.jpg",
    rating: 4.9,
    rate: 58,
    experience: "13yr",
    tags: ["Chemistry", "Biology"],
  },
  {
    ...
    background: "/assets/images/science/img10.jpg",
    rating: 4.8,
    rate: 46,
    experience: "9yr",
    tags: ["Physics"],
  },
  {
    ...
    degree: "Ph.D, Chemistry",
    image:
      "https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?w=200&h=200&fit=crop",
    background: "/assets/images/science/img11.jpg",
    rating: 4.7,
    rate: 49,
    experience: "10yr",
    tags: ["Chemistry", "Biology"],
  },
  {
    ...
    degree: "M.Sc, Biology",
    image:
      "https://images.unsplash.com/photo-1544005313-7b4f17dca356?w=200&h=200&fit=crop",
    background: "/assets/images/science/img12.jpg",
    rating: 5.0,
    rate: 53,
    experience: "8yr",
    tags: ["Biology"],
  },
  {
    ...
    degree: "M.Sc, Physics",
    image:
      "https://images.unsplash.com/photo-1502767089025-6572583495b2?w=200&h=200&fit=crop",
    background: "/assets/images/science/img13.jpg",
    rating: 4.9,
    rate: 50,
    experience: "11yr",
    tags: ["Physics", "Chemistry"],
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?w=200&h=200&fit=crop",
    background: "/assets/images/science/img14.jpg",
    rating: 4.8,
    rate: 48,
    experience: "7yr",
    tags: ["Chemistry"],
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop",
    background: "/assets/images/science/img15.jpg",
    rating: 4.9,
    rate: 44,
    experience: "12yr",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=200&h=200&fit=crop",
    background: "/assets/images/science/img16.jpg",
    rating: 5.0,
    rate: 56,
    experience: "9yr",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&h=200&fit=crop",
    background: "/assets/images/science/img17.jpg",
    rating: 4.7,
    rate: 47,
    experience: "7yr",
    tags: ["Chemistry"],
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=200&h=200&fit=crop",
    background: "/assets/images/science/img18.jpg",
    rating: 4.8,
    rate: 49,
    experience: "6yr",
    tags: ["Physics", "Biology"],
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop",
    background: "/assets/images/science/img19.jpg",
    rating: 5.0,
    rate: 61,
    experience: "15yr",
    tags: ["Physics", "Chemistry"],
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1544725176-7c40e5a2c9f9?w=200&h=200&fit=crop",
    background: "/assets/images/science/img20.jpg",
    rating: 4.9,
    rate: 51,
    experience: "11yr",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=200&h=200&fit=crop",
    background: "/assets/images/science/img21.jpg",
    rating: 4.9,
    rate: 57,
    experience: "13yr",
    tags: ["Chemistry"],
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop",
    background: "/assets/images/science/img22.jpg",
    rating: 4.8,
    rate: 46,
    experience: "10yr",
    tags: ["Physics", "Chemistry"],
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop",
    background: "/assets/images/science/img23.jpg",
    rating: 4.9,
    rate: 45,
    experience: "12yr",
    tags: ["Physics"],
          ...
          <div
            ...
            <div
              ...
              <div style={{ marginTop: "-1rem" }} className="title-wrapper">
                <span className="pricinggg-subtitle">Platform Terms</span>
                <h2 className="pricinggg-title">Terms for using EduGlobalOnline.</h2>
              </div>
              <div className="terms-container">
                <div className="terms-section">
                  <div className="number-circle">01</div>
                  <div className="terms-content">
                    <h3 className="terms-title">Acceptance of Terms</h3>
                    <p className="terms-text">
                      By using EduGlobalOnline's website, apps, or services, you
                ...
                <div className="terms-section">
                  ...
                  <div className="terms-content">
                    <h3 className="terms-title">Services Provided</h3>
                    <p className="terms-text">
                      EduGlobalOnline offers online tutoring, courses, and
                      related educational resources. All content, courses, and
                      tutoring sessions are provided for educational purposes
                      only.
                    </p>
                  </div>
                </div>
