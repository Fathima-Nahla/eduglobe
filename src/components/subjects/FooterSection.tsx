            ...
            <div className="section-header">
              <div className="section-title-wrapper fade-anim" suppressHydrationWarning={true}>
                <div className="subtitle-wrapper">
                  <span className="footersec-subtitle">{footerData?.cta?.subtitle}</span>
                </div>
          ...
          <div className="footer-widget-wrapper">
            ...
            <div className="footer-widget-box">
              <div className="info-box">
                <div style={{width: "180px"}} className="footer-logo">
          ...
          <div className="copyright-area-inner">
            ...
            <ul className="copyright-nav-list">
              {footerData?.copyright?.links?.map((item:IFooterLink, idx:number) => (
                <li key={idx}>
                  <Link target="_blank" style={{zIndex: 40}} href={item?.url || "#"}>{item?.label}</Link>
                </li>
              ))}
            </ul>
          </div>
