...
import { IPortfolioDetailsData } from "@/constant/MarketingAgency/PortfolioDetails/portfolio-details-data";

interface PortfolioProps {
  data: IPortfolioDetailsData;
}

const MathematicsDetails: React.FC<PortfolioProps> = ({
    ...
    <>
      <section className="work-details-area ">
        <div className="container">
          <div className="work-details-area-inner section-spacing-top section-spacing-bottom">
